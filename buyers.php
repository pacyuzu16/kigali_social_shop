...
<body>
 ...
 if($results){ 
    echo "There is ".$rowcount=mysqli_num_rows($results)." registered clients"; 
 }else{
   echo "0";
 }
  ?>
...
include("Connection.php");
                ...
                while($r= mysqli_fetch_array($results)){
                    ...
                    <td>".$r['address']."</td>";
                    echo "
                    <td><a href='ViewUser.php?CustomerId=$r[CustomerId]'> View </a></td>
                    <td><a href='EditUser.php?CustomerId=$r[CustomerId]'> Edit </a></td>
                    <td><a href='DeactivateUser.php?CustomerId=$r[CustomerId]'> Deactivate </a></td>
                    </tr>";
                }
                echo "</table>";
