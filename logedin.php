...
<div class="image-container">
  ...
  <div class="products">
   <table border="0"width="100%">
    ...
    <tr><td><s>$50 </s>&nbsp; $45 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$40 </s>&nbsp; $20 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$60 </s>&nbsp; $50 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$89 </s>&nbsp; $50 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td></tr><!--end of First row 2-->
    ...
    <tr><td><s>$50 </s>&nbsp; $45 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$40 </s>&nbsp; $20 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$60 </s>&nbsp; $50 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td><!--&nbsp; is for adding a-->
    <td><s>$89 </s>&nbsp; $50 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td></tr><!--end of  row 2-->
    ...
    <tr><td><s>$50 </s>&nbsp; $45 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$40 </s>&nbsp; $20 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td>
    <td><s>$60 </s>&nbsp; $50 &nbsp; <input type="submit"value="Like this Productt"name="submit"id="myButton"></td><!--&nbsp; is for adding a-->
    <td><s>$89 </s>&nbsp; $50 &nbsp; <input type="submit"value="Like this Product"name="submit"id="myButton"></td></tr><!--end of row 3-->
